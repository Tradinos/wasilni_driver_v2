...
import com.tradinos.wasilnidriver.mvp.presenter.LocationsPresenterImp;
import com.tradinos.wasilnidriver.mvp.presenter.NationalitiesPresenterImp;
        ...
        cdp = new CalendarDatePickerDialogFragment()
                .setOnDateSetListener(new CalendarDatePickerDialogFragment.OnDateSetListener() {
                    ...
                    public void onDateSet(CalendarDatePickerDialogFragment dialog, int year, int monthOfYear, int dayOfMonth) {
                        birthdateTV.setText( UtilFunction.generateDate(year, monthOfYear , dayOfMonth) );
                    }
                })
